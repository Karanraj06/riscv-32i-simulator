      ...
      <div className='grid place-items-center p-4 gap-4'>
        ...
        <div className='grid md:grid-flow-col md:grid-cols-2 gap-20 items-start mt-10'>
          <div className='flex flex-col space-y-4'>
            <h1 className='text-2xl font-bold mb-4'>Instruction Cache</h1>
            ...
            <div className='flex flex-col space-y-1'>
              <label htmlFor='associativity'>
                # associativity = 2 ^ associativity_exponent (non-negative)
                <br />
            ...
            <div className='flex flex-col space-y-1'>
              <label htmlFor='miss'>Miss Penality (non-negative)</label>
              <input
                id='miss'
                type='number'
                value={miss}
